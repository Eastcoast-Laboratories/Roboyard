...
public class GridGameScreen extends GameScreen {
    ...
    public void draw(RenderManager renderManager) {
        ...
        renderManager.setColor(Color.parseColor("#00ad00")); // Dark green for the background rectangle
        ...
        renderManager.drawRoundRect(0, 0, screenWidth, gridHeight + 2 * layout.x(topMargin), layout.x(9));
    ...
    public void updateAllZIndices() {
        ...
        int baseZIndex = ZIndexConstants.GAME_OBJECT_BASE;
        for (Object obj : allObjects) {
            if (obj instanceof Wall) {
                ...
                if ((wallY == 0 && type.equals("mh"))) {
                    wall.setZIndex(ZIndexConstants.GAME_OBJECT_BASE - 5000); // Fixed z-index for board edge walls
                } else {
