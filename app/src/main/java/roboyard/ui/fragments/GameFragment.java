...
public class GameFragment extends BaseGameFragment implements GameStateManager.SolutionCallback {
    ...
    private static final int BUTTON_COOLDOWN_MS = 2000; // 2 seconds for long-press
    ...
    private final Runnable timerRunnable = new Runnable() {
        ...
        public void run() {
            try {
                ...
                // Do NOT use Timber here - it allocates strings which causes recursive OOM
            }
    ...
    private void initializeGame() {
        ...
        if (moveCount == 0) {
            ...
            // DO NOT clear paths - just reconstruct them from the stored history
            if (gameGridView != null) {
